...
$(function(){
    ...
    function getOptionalFields (rowNumber) {
        ...
        var chphl_wants_everything_optional = true;

        if(chphl_wants_everything_optional || is_SickleCell_Form){
    ...
    $("tr.parent_row").on("focusout", function(event) {
        ...
        function movedToNewRow() {
            ...
            // console.log("movedToNewRow()... ");
            // console.log("movedToNewRow()... from_row = " + from_row );
            // console.log("movedToNewRow()... dest_row = " + dest_row);
    ...
    function dataEntryCompleted( rowNumber ){// returns the data (or null if incomplete)
        ...
        if(the_tests === null){
            console.log('xxx:.....'+rowNumber);
            $("#PCR_test_requested_"+rowNumber).val("YES");// default test is PCR
            console.log("#PCR_test_requested_"+rowNumber);
